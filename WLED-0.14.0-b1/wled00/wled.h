...
//编译html npm run build
//自动检查更改 npm run dev
#define VERSION 2306300
//#define Versions6_1   //RGB灯光控制器版本 6.1
#define Versions6_2     //RGB灯光控制器版本 6.2
...
WLED_GLOBAL char mqttServer[33] _INIT("182.61.138.83");                 // both domains and IPs should work (no SSL)
WLED_GLOBAL char mqttUser[41] _INIT("ckhw");                   // optional: username for MQTT auth
WLED_GLOBAL char mqttPass[65] _INIT("ckhw123456");                   // optional: password for MQTT auth
